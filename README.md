...
1、配置好Flutter开发环境(目前Flutter SDK 版本 **3.3**)，可参阅 [【搭建环境】](https://flutterchina.club)。
...
>### 1、本地 Flutter SDK 版本 3.3 ； 2、是否执行过 `flutter pub get`；3、 网络等问题参考: [如果出现登陆失败或者请求失败 ](https://github.com/CarGuo/gsy_github_app_flutter/issues/643)
